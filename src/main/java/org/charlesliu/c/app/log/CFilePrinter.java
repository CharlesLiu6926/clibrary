 ...
 */
public class CFilePrinter implements CLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static CFilePrinter instance;
     ...
     */
    public static synchronized CFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new CFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private CFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull CLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new CLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(CLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<CLogMo> logs = new LinkedBlockingQueue<>();
